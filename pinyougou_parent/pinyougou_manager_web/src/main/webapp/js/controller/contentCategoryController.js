	...
	var app = new Vue({
		...
		methods:{
			...
			findPage:function (pageNo) {
				axios.post("../contentCategory/findPage.do?pageNo="+pageNo+"&pageSize="+10,this.searchEntity)
			...
			//新增
			add:function () {
				var url = "../contentCategory/add.do";
			...
			//跟据id查询
			getById:function (id) {
				axios.get("../contentCategory/getById.do?id="+id).then(function (response) {
