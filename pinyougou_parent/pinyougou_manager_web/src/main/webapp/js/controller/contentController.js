...
window.onload=function () {
	...
	var app = new Vue({
		...
		methods:{
			//查询所有
			findAll:function () {
				axios.get("../content/findAll.do").then(function (response) {
					//vue把数据列表包装在data属性中
			...
			findPage:function (pageNo) {
				axios.post("../content/findPage.do?pageNo="+pageNo+"&pageSize="+10,this.searchEntity)
			...
			//跟据id查询
			getById:function (id) {
				axios.get("../content/getById.do?id="+id).then(function (response) {
